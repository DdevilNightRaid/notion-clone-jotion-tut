                ...
                <p className="hidden last:block text-xs text-center text-muted-foreground pb-2">No Documents found</p>
                {
                    filterdDocuments?.map((document) => (
                        <div
                            ...
                            className='text-sm rounded-sm w-full hover:bg-primar/5 flex items-center text-primary justify-between '
                        >
                            <span className="trucate pl-2 ">
                                {document.title}
                            </span>
                            <div className="flex items-center">
                                ...
                                >
                                    <div
                                        role='button'
                                        className="rounded-sm hover:bg-neutral-200 dark:bg-neutral-600"
                                    >
